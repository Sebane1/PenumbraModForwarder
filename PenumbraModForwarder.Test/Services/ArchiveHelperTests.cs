...
namespace PenumbraModForwarder.Test.Services
{
    public class ArchiveHelperTests
    {
        ...
        public void ExtractArchive_ShouldThrowArgumentNullException_WhenFilePathIsNullOrEmpty()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => _serviceMock.Object.ExtractArchive(filePath));
        ...
        public void ExtractArchive_ShouldCallInstallArkFile_WhenArchiveContainsRolePlayVoiceFile()
        {
            ...
            _serviceMock.Object.ExtractArchive(filePath);
        ...
        [Fact]
        public void ExtractArchive_ShouldExtractAndInstallFile_WhenSingleFileInArchive()
        {
            var files = new[] { "mod.ttmp2" };
            var tempZipPath = CreateDummyZipFile("mod.ttmp2");
            _serviceMock.Setup(service => service.GetFilesInArchive(It.IsAny<string>())).Returns(files);
            _serviceMock.Object.ExtractArchive(tempZipPath);
        ...
        [Fact]
        public void ExtractArchive_ShouldShowFileSelector_WhenMultipleFilesInArchiveAndExtractAllIsFalse()
        {
        ...
        [Fact]
        public void ExtractArchive_ShouldDeleteArchive_WhenAutoDeleteIsTrue()
        {
            var files = new[] { "mod.ttmp2" };
            var tempZipPath = CreateDummyZipFile("mod.ttmp2");
            _serviceMock.Setup(service => service.GetFilesInArchive(It.IsAny<string>())).Returns(files);
