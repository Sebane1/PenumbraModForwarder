...
public class TexToolsHelper : ITexToolsHelper
{
    ...
    {
        if ((string)_configurationService.ReturnConfigValue(model => model.Watchdog.TexToolPath) != string.Empty)
        {
        ...
        _configurationService.UpdateConfigValue(config => config.Watchdog.TexToolPath = combinedPath);
